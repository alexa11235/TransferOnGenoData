...
-Image 3 () Compares the 4 models (RR, ARR, Transfer_RR and Transfer_ARR) in terms of Pearson's correlation and should coincide statistically with Appendix Figure A4 (b)
-Image 4 () Compares the 4 models (RR, ARR, Transfer_RR and Transfer_ARR) in terms of NRMSE and should coincide statistically with Appendix Figure A4 (b)

-CSV 1 is now  and contains coeficients of all 4 models.
-CSV 3 is now  and contains results for all 4 models.
-CSV 4 is now  and contains predictions for all 4 models.
